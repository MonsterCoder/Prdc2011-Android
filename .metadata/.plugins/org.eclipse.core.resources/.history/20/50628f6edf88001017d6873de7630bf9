prdc.views.TweetList = Ext.extend(Ext.Panel, {
    ...
    initComponent: function(){
        ...
        this.list = new Ext.List({
            itemTpl: new Ext.XTemplate('<tpl if="profile_image_url"> <img src="{profile_image_url}"/> </tpl><div class="tweet"><strong>{from_user}</strong><tpl if="to_user"> &raquo; {to_user}</tpl><br />{text:this.linkify}</div>', {
